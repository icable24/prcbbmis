<?php 
    ...
    if ( null==$id ) {
        ...
        $sql = "SELECT * FROM tmpbloodcomponent where bcid = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($id));
    ...
    <div class="container">
        ...
        <div class="panel panel-info">    
                <div class="panel panel-body"> 
                    <form class="form-horizontal" action="./php/tmpbcdelete.php" method="post">
                        ...
                        <?php
                            ...
                            echo '<div class="alert alert-warning" role="alert">Proceed in deleting this user: '.$data['bloodcomponent'].' ?</div>';
                        ?>
